...
class Config:
    def __init__(self):
        ...
        # Images
        self.DEFAULT_THUMB: str = getenv("DEFAULT_THUMB", "https://files.catbox.moe/rlhj2v.jpg")
        self.PING_IMG: str = getenv("PING_IMG", "https://files.catbox.moe/rlhj2v.jpg")
        self.START_IMG: str = getenv("START_IMG", "https://files.catbox.moe/rlhj2v.jpg")
        self.RADIO_IMG: str = getenv("RADIO_IMG", "https://files.catbox.moe/rlhj2v.jpg")
